...
%   [Iw,Isd,num]=cspair(marksd,ST,markSDtotal)
%   [Iw,Isd,num,]=cspair(marksd,ST,markSDtotal,param)
% markSDtotal is the number of all spikes which marksd is in.
function [IW,ISD,rpNum,varargout]=cspair(marksd,ST,sAmtMark,param)
flagFilt=true;
...
%%%
wd=[marksd-param.ext,marksd+param.ext];% Make into bins
